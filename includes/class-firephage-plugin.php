...
final class Plugin
{
    ...
    public function registerPrivacyPolicyContent(): void
    {
        ...
        wp_add_privacy_policy_content(
            ...
            wp_kses_post(
                '<p>' . esc_html__('FirePhage Security can contact external services in three cases.', 'firephage-security') . '</p>' .
                '<p>' . esc_html__('For checksum verification, the plugin can use FirePhage checksum cache first when you explicitly enable it, with WordPress.org remaining available as fallback. Those requests include only package identifiers needed for local verification.', 'firephage-security') . '</p>' .
